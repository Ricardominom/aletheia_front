...
// import SecondaryIndicators from "../components/SecondaryIndicators"; // Not used
// import FinanceStatus from "../components/FinanceStatus"; // Commented out as requested
import TacticalTracking from "../components/TacticalTracking";
import SocialListening from "../components/SocialListening";
// import OperationProgress from "../components/OperationProgress"; // Commented out as requested
// import OperationMetrics from "../components/OperationMetrics"; // Commented out as requested
            ...
            {activeTab === "encuestas" && (
              <>
                ...
                <div className="grid grid-cols-12 gap-6">
                  {/* Main Overview Card - Expanded for better proportions */}
                  ...
                  {/* Strategic Content Card - Expanded to fill remaining space */}
                  ...
                  {/* Finance Status - Commented out as requested */}
                ...
                {/* Operations Section - Commented out as requested */}
                {/* <div className="grid grid-cols-12 gap-6">
                  <div className="col-span-12 lg:col-span-4">
