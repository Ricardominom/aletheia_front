      ...
      <div className="flex items-center justify-between mb-4 relative z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-400 text-xs">Histórico de inversión por microsegmentos y geolocalización (USD)</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="bg-card/50 rounded-lg border border-blue-500/20">
            <div className="p-3 border-b border-blue-500/20">
              <h3 className="text-sm font-semibold text-white">Microsegmentos</h3>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-blue-500/20 bg-blue-500/5">
                    <th className="text-left p-2 text-gray-300 font-medium text-xs">Microsegmentos</th>
                    <th className="text-right p-2 text-gray-300 font-medium text-xs">Inversión</th>
                    <th className="text-right p-2 text-gray-300 font-medium text-xs">Share</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-blue-500/10">
                  {data.microsegments.map((segment, index) => (
                    <tr key={index} className="hover:bg-blue-500/5 transition-colors">
                      <td className="p-2 text-white font-medium text-xs">{segment.name}</td>
                      <td className="p-2 text-right text-blue-400 font-medium text-xs">
                        {formatCurrency(segment.investment)}
                      </td>
                      <td className="p-2 text-right text-blue-300 font-medium text-xs">
                  ...
                  <tr className="border-t-2 border-blue-500/30 bg-blue-500/10">
                    ...
                    <td className="p-2 text-right text-blue-300 font-bold text-xs">100.00%</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="bg-card/50 rounded-lg border border-purple-500/20">
            <div className="p-3 border-b border-purple-500/20">
              <h3 className="text-sm font-semibold text-white">Geolocalización</h3>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-purple-500/20 bg-purple-500/5">
                    <th className="text-left p-2 text-gray-300 font-medium text-xs">Geolocalización</th>
                    <th className="text-right p-2 text-gray-300 font-medium text-xs">Inversión</th>
                    <th className="text-right p-2 text-gray-300 font-medium text-xs">Share</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-purple-500/10">
                  {data.geolocations.map((location, index) => (
                    <tr key={index} className="hover:bg-purple-500/5 transition-colors">
                      <td className="p-2 text-white font-medium text-xs">{location.name}</td>
                      <td className="p-2 text-right text-purple-400 font-medium text-xs">
                        {formatCurrency(location.investment)}
                      </td>
                      <td className="p-2 text-right text-purple-300 font-medium text-xs">
                  ...
                  <tr className="border-t-2 border-purple-500/30 bg-purple-500/10">
                    ...
                    <td className="p-2 text-right text-purple-300 font-bold text-xs">100.00%</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div className="bg-card/50 rounded-lg p-3 border border-blue-500/20">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-sm font-semibold text-white">Impresiones Totales</h3>
                <p className="text-gray-400 text-xs">Alcance total de la campaña</p>
              </div>
            </div>
            <div className="text-right">
              <div className="text-xl font-bold text-blue-500 text-neon">
