    ...
    <div className="glassmorphic-container p-5 animate-scale-in">
      ...
      <div className="flex items-center justify-between mb-5 relative z-10">
        <div className="flex items-center gap-3">
          <div className="bg-gradient-to-br from-pink-500/10 to-purple-600/10 p-2 rounded-lg border border-pink-500/20">
          ...
          <div>
            ...
            <p className="text-gray-400 text-xs">Jul 20 - Aug 18</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-5 relative z-10">
        ...
        <div className="grid grid-cols-12 gap-3">
          ...
          <div className="col-span-6 grid grid-cols-2 gap-2">
            <div className="bg-card/50 rounded-lg p-2 border border-pink-500/20 group hover:border-pink-500/40 transition-all duration-300">
              <div className="flex items-center gap-2 mb-2">
                <Eye className="w-3 h-3 text-pink-400" />
                <span className="text-[10px] text-gray-400 uppercase">Vistas</span>
              </div>
              <div className="text-xl font-bold text-pink-500 text-neon animate-float">
                6.0M
              </div>
            </div>
            ...
            <div className="bg-card/50 rounded-lg p-2 border border-pink-500/20 group hover:border-pink-500/40 transition-all duration-300">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] text-gray-400 uppercase">Interacciones</span>
              </div>
              <div className="text-xl font-bold text-pink-500 text-neon animate-float">
                {metrics.interactions}
              </div>
              <div className="text-[10px] text-gray-400 mt-1">{metrics.interactionsFromAds} de anuncios</div>
            </div>

            <div className="bg-card/50 rounded-lg p-2 border border-pink-500/20 group hover:border-pink-500/40 transition-all duration-300">
              <div className="flex items-center gap-2 mb-2">
                <Users className="w-3 h-3 text-pink-400" />
                <span className="text-[10px] text-gray-400 uppercase">Nuevos seguidores</span>
              </div>
            ...
            <div className="bg-card/50 rounded-lg p-2 border border-pink-500/20 group hover:border-pink-500/40 transition-all duration-300">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] text-gray-400 uppercase">Contenido compartido</span>
              </div>
              <div className="text-xl font-bold text-pink-400 text-neon">
          ...
          <div className="col-span-6 bg-card/50 rounded-lg p-3 border border-pink-500/20">
            <h4 className="text-xs font-medium text-gray-400 mb-2 uppercase">Tipo de Audiencia</h4>
              ...
              <div className="flex-1 space-y-1">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-300 font-medium">Seguidores</span>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-300 font-medium">No seguidores</span>
                  </div>
        ...
        {/* Accounts Reached */}
        <div className="bg-background/30 rounded-lg p-2 border border-pink-500/20 mb-3">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-xs text-gray-400 mb-1">Cuentas alcanzadas</div>
              <div className="text-lg font-bold text-pink-500">{metrics.accountsReached}</div>
            </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="bg-card/50 rounded-lg p-3 border border-pink-500/20">
            <h4 className="text-[10px] font-medium text-gray-400 mb-2 uppercase">Por tipo de contenido</h4>
          ...
          {/* Locations */}
          <div className="bg-card/50 rounded-lg p-3 border border-pink-500/20">
            <h4 className="text-[10px] font-medium text-gray-400 mb-2 uppercase">Principales ubicaciones</h4>
          ...
          {/* Age Range */}
          <div className="bg-card/50 rounded-lg p-3 border border-pink-500/20">
            <h4 className="text-[10px] font-medium text-gray-400 mb-2 uppercase">Rango de edad</h4>
