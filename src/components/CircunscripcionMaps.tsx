...
export default function CircunscripcionMaps() {
    ...
    return (
        <div className="glassmorphic-container p-2 h-[550px] overflow-hidden animate-scale-in">
            {/* Background effects */}
            ...
            <div className={`relative h-[510px] rounded-lg overflow-hidden group ${isZoomed ? 'cursor-zoom-out' : 'cursor-zoom-in'}`}>
